  ...
  return (
    <div className="bg-black min-h-screen overflow-x-hidden">
      ...
      <main id="main-content" className="pt-20">
              ...
              {[
                ...
                <AnimateIn key={i} delay={i * 0.12}>
                  <div
                    ...
                    style={{ borderLeft: `3px solid ${item.color}`, border: `1px solid ${item.color}20`, borderLeftWidth: '3px', borderLeftColor: item.color }}
                  >
        ...
        {/* ===== WHAT YOU'LL WALK AWAY WITH (DARK) ===== */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mb-12">
              {[
                ...
                <AnimateIn key={i} delay={i * 0.1}>
                  <div
                    className="flex gap-5 p-6 rounded-2xl bg-white/[0.03] hover:bg-white/[0.06] transition-all duration-300"
        ...
        {/* ===== HOW IT WORKS (DARK) ===== */}
        <section className="bg-[#0A0A0A] py-20 sm:py-28 px-6 sm:px-8 border-t border-white/5" aria-labelledby="process-heading">
          <div className="max-w-5xl mx-auto">
            <AnimateIn className="text-center mb-16 sm:mb-20">
              <h2 id="process-heading" className="text-3xl sm:text-5xl font-black text-white tracking-tight mb-4">How it works</h2>
        ...
        {/* ===== FAQ (DARK) ===== */}
        <section className="bg-[#111] py-20 sm:py-28 px-6 sm:px-8" aria-labelledby="faq-heading">
